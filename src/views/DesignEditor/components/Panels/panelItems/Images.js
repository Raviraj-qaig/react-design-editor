...
const Images = () => {
    ...
    return (_jsxs(Block, { "$style": { flex: 1, display: "flex", flexDirection: "column" }, children: [_jsxs(Block, { "$style": {
                    ...
                    padding: "1.5rem",
                }, children: [_jsx(Block, { children: "Images" }), _jsx(Block, { onClick: () => setIsSidebarOpen(false), "$style": { cursor: "pointer", display: "flex" }, children: _jsx(AngleDoubleLeft, { size: 18 }) })] }), _jsx(Scrollable, { children: _jsx(Block, { padding: "0 1.5rem", children: _jsx("div", { style: { display: "grid", gap: "8px", gridTemplateColumns: "1fr 1fr" }, children: images.map((image, index) => {
                            return _jsx(ImageItem, { onClick: () => addObject(image.src.large), preview: image.src.small }, index);
                        }) }) }) })] }));
};
