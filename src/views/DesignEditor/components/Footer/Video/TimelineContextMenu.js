...
const TimelineContextMenu = () => {
    ...
    const { scenes, setScenes, setContextMenuTimelineRequest, contextMenuTimelineRequest, setCurrentScene, setCurrentDesign, } = useDesignEditorContext();
    ...
    return (_jsxs(Block, { ref: ref, "$style": {
            width: "160px",
            position: "absolute",
            ...
            padding: "0.5rem 0",
        }, children: [_jsx(Block, { onClick: makeDuplicateScene, "$style": {
                    fontSize: "14px",
                    height: "28px",
                    display: "flex",
                    alignItems: "center",
                ...
                }, children: "Duplicate Scene" }), _jsx(Block, { onClick: makeDeleteScene, "$style": {
                    fontSize: "14px",
                    height: "28px",
                    display: "flex",
                    alignItems: "center",
